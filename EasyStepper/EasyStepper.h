...
class EasyStepper {
  public:
	...
	void updateMotorPosition(int direction);
	int calculateHourPosition(int numOfSteps);
	int calculateMinutePosition(int numOfSteps);
  ...
  private:
	...
	int calculateHourOffsetPosition(int offset);
	int calculateMinuteOffsetPosition(int offset);
